...
public class DateCalculatorUtils {
    public static final String TAG = "DateCalculatorUtils";
...
//        Log.e("test", "generateOneScreenDataWeek-->>unixStart-->>" + new java.util.Date(unixStart * 1000L) + ", unixEnd-->>" + new java.util.Date(unixEnd * 1000L) + ", selectedUnix-->>" + new java.util.Date(selectedUnix * 1000L));
...
//                    Log.d(TAG,"当前月-->>"+unixCurrent);
    ...
    public static CalendarOneScreenDataWeek generateOneScreenDataWeek(long selectedUnix, long startUnix, long endUnix, CalendarTipResponse calendarTipResponse) {
